...
import ImgErro from "../../assets/image/erro.png"
import "./style.css";
...
function Error404() {
  ...
  let oh = document.querySelector(".circulo.oh");
  ...
  return (
    <div className="container-error">
      ...
      <div class="center">
        <div class="circulo circulo--outer"></div>
        <div class="circulo circulo--inner">
          <img src={ImgErro} className="img-erro" />
          <div class="circulo oh">
            <div class="astronaut">
          ...
          <div className="btn-back-navigate" onClick={() => handleBack()}>
            Voltar para navegação
          </div>
        </div>
        <div class="sorry">Oops! Desculpa, não achamos esta pagina.</div>
      </div>
    </div>
  );
}
